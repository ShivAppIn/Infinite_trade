...
export const ABS_OPPORTUNITES = `/${routes.OPPORTUNITIES}`;
...
export const ABS_SUB_ADMINS = `/${routes.ROLES_ACCESS}/${routes.SUB_ADMINS}`;
export const ABS_SUB_ADMIN_ADD = `/${routes.ROLES_ACCESS}/${routes.SUB_ADMINS}/${routes.ADD}`;
export const ABS_SUB_ADMIN_EDIT = `/${routes.ROLES_ACCESS}/${routes.SUB_ADMINS}/${routes.EDIT}`;
export const ABS_SUB_ADMIN_DETAILS = `/${routes.ROLES_ACCESS}/${routes.SUB_ADMINS}/${routes.DETAILS}`;
